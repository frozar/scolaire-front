...
import { getConflictWays } from "./VoirieItems";
import { setdisplayedUpdateVoirieConfirmation } from "./WayDetails";
            ...
            <div
              ...
              use:ClickOutside={(e: MouseEvent) => {
                ...
                if (!refDialogueBox.contains(e.target)) {
                  setdisplayedUpdateVoirieConfirmation(false);
                }
              }}
            >
              <div class="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
                <button
                  ...
                  onClick={() => setdisplayedUpdateVoirieConfirmation(false)}
                >
              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <Show when={getConflictWays().length == 1}>
                    <h3
                      class="text-base font-semibold leading-6 text-gray-900"
                      id="modal-title"
                    >
                      Un conflit a été détécté
                    </h3>
                  </Show>
                  <Show when={getConflictWays().length > 1}>
                    <h3
                      ...
                      id="modal-title"
                    >
                      {getConflictWays().length} conflits ont été détéctés
                    </h3>
                  </Show>

                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      Les pondérations détéctées seront supprimées avant la mise
                      à jour
