...
describe("SettingsContentAnimationParameters atom", () => {
  ...
  it("selected checkbox", () => {
    cy.mount(() => <SettingsContentAnimationParameters />);
    cy.get(".settings-content-animation-parameter").compareSnapshot(
      "selected",
      0.01
    );
  });
  ...
  it("unselect checkbox", () => {
    cy.mount(() => <SettingsContentAnimationParameters />);
    cy.get(".settings-content-animation-parameter input").then((input) => {
